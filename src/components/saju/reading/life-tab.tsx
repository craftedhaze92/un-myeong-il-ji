    ...
    <div className="flex flex-col gap-5.5">
      <div className="border-line flex items-center justify-between gap-3 border-b pb-3">
        <p className="text-small text-mute">
          핵심만 빠르게 보거나, 근거와 생애 흐름까지 이어서 읽을 수 있습니다.
        </p>
        <div className="flex shrink-0 gap-1">
          <button
            ...
            className="border-line text-small cursor-pointer rounded-[2px] border bg-transparent px-3 py-1.5"
            style={{
              color: !detailed ? "var(--fg)" : "var(--mute)",
              borderColor: !detailed ? "var(--fg)" : "var(--line)",
            }}
          >
            핵심 요약
          </button>
        ...
        <>
          ...
          <div>
            <p className="text-small text-mute mb-3 leading-[1.7]">
              아래 점수는 미래 사건의 확률이 아니라 명식 안의 자원과 부담을
              비교한 해석 지표입니다.
            </p>
