...
import type { YongSinMethod } from '../../types/interpretation';
import type { YongSinAlgorithm, YongSinResult } from './base';
import { StrengthYongSinAlgorithm } from './strength_algorithm';
import { SeasonalYongSinAlgorithm } from './seasonal_algorithm';
import { MediationYongSinAlgorithm } from './mediation_algorithm';
import { DiseaseYongSinAlgorithm } from './disease_algorithm';
