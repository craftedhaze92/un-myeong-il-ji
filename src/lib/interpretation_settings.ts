...
import type { UserInterpretationSettings, SchoolCode, YongSinMethod, PrioritySettings } from '../types/interpretation';
import { DEFAULT_PRESETS, SCHOOL_WEIGHTS } from '../data/school_presets';
