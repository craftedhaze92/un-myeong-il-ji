...
import type { CalendarType, CalendarConversion } from '../types/index';
import { getCurrentSolarTermPrecise } from '../data/solar_terms';
import { solarToLunarLocal, lunarToSolarLocal } from '../data/lunar_table';
