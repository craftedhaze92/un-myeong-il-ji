...
import type { SchoolCode, UserInterpretationSettings } from '../../types/interpretation';
import type { SchoolInterpreter } from '../school_interpreter';
import { ZipingInterpreter } from './ziping_interpreter';
import { ModernInterpreter } from './modern_interpreter';

// 간단한 기본 해석기 (나머지 3개 유파용)
import { BaseSchoolInterpreter } from '../school_interpreter';
import { YongSinSelector } from '../yongsin/selector';
import type { SajuPillars } from '../../types/index';
...
export * from './ziping_interpreter';
export * from './modern_interpreter';
